                ...
                <div id="formulario">
                    <form name="form" id="form_user" action="pdf_guia_marcha.php?id_funcionario=<?php echo $_GET['id_funcionario']; ?>" method="post" enctype="multipart/form-data" target="new">
                        <fieldset>
                            ...
                            <label>
                                <span>Destino</span>
                                <input type="text" name="destino" id="destino" value="Posto de Saúde Barra do Kwanza"/>
                            </label>

                            <label>
                                <span>Proveniência</span>
                                <input type="text" name="proveniencia" id="proveniencia" value="Centro de Saúde Materno Wenji Maka II"/>
                            </label>
