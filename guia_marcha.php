                        ...
                        foreach ($funcionario as $funcionarios) {
                            ...
                            <tr>
                                ...
                                <td style="width: 120px; padding:0 10px;"> 
                                    <a href="index.php?<?php echo md5('pagina emitir marcha'); ?>&id_funcionario=<?php echo $funcionarios['idfuncionario']; ?>" title="Emitir uma guia de Marcha">Emitir Declaração</a>
                                </td>
                                <?php $i++;
                            }
                            ?>
