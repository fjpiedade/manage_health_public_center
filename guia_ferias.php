...
if (isset($_SESSION['LOGIN']) && $_SESSION['LOGIN'] == true) {
    ...
    <div id="corpo">
        <div id="tabs">
            ...
            <div id="tabs-1">
                <a href="pdf_mapa_ferias_completo.php?idmapaferias=<?php echo $mapa['idmapaferias']; ?>" target="new">Imprimir Mapa</a>
                <br />
                <br />
                <?php
                        ...
                        foreach ($funcionario as $funcionarios) {
                            ...
                            <tr>
                                ...
                                <td style="width: 120px; padding:0 10px;"> 
                                    <a href="index.php?<?php echo md5('pagina emitir feria'); ?>&id_funcionario=<?php echo $funcionarios['idfuncionario']; ?>" title="Emitir uma guia de Férias">Emitir Declaração</a>
                                </td>
                                <?php $i++;
                            }
                            ?>
