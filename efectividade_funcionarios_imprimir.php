    ...
    <div id="corpo">
        <div id="tabs">
            ...
            <div id="tabs-1">
                 ...
                 */
                ?>
                <form name="form" id="form_user" action="pdf_efectividade_funcionarios.php?idefectividade=<?php echo $_GET['idefectividade']; ?>" method="post" enctype="multipart/form-data" target="new">
                    <?php
                    ...
                    <br />
                    <input type="submit" id="button" class="send" value="Imprimir" name="btnprocessar"/>
                            ...
                            foreach ($funcionario as $funcionarios) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 120px; padding:0 10px;" align="center"> 
                                        ...
                                        ?>
                                        <input type="text" name="dias" id="dias" style=" width: 30px; text-align: center;" value="<?php echo $count_dia; ?>" disabled="true" />
                                    </td>
                                    <td style="width: 120px; padding:0 10px;" align="center"> 
                                        <!--<a href="index.php?<?php echo md5('pagina transferir'); ?>&id_funcionario=<?php echo $funcionarios['idfuncionario']; ?>" title="Emitir uma guia de Férias">Transferir</a>-->
                                        <?php
                                        ...
                                        ?>
                                        <input type="text" name="horas" id="horas" style=" width: 30px; text-align: center;" value="<?php echo $horas_final; ?>" disabled="true"/>
                                    </td>
