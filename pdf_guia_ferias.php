...
$pdf->Cell(0, 10, "GUIA DE FÉRIAS N°".$number_guia." RH/RMSF/" . date('Y'), 0, 1, 'C');
...
$pdf->Write(5, 'A Pela presente, se faz constar que no dia ');

$pdf->SetFont('helvetica', 'B', 14);
$pdf->Write(5, $dataInicio.'');

$pdf->SetFont('helvetica', '', 14);
$pdf->Write(5, ', entra em gozo de ');

$pdf->SetFont('helvetica', 'B', 14);
$pdf->Write(5, $qtDias.' ');

$pdf->SetFont('helvetica', '', 14);
$pdf->Write(5, ' dias de licença disicplinar o(a) Sr(a). ');
...
$pdf->Write(5, ', colocado(a) no ' . $localColocado . ', com a categoria de ' . $categoria . '. Considerado pelo despacho do Sr. Director de Repartição Municipal de Saúde de Belas.');

//$pdf->Ln(8);
//$pdf->SetFont('helvetica', '', 14);
//$pdf->MultiCell(0, 0, $texto, 0, 'L');

$pdf->Ln(10);
$pdf->SetFont('helvetica', '', 14);
$pdf->MultiCell(0, 0, $texto1, 0, 'L');
$pdf->Ln(5);
$pdf->SetFont('helvetica', '', 14);
