...
if (isset($_SESSION['LOGIN']) && $_SESSION['LOGIN'] == true) {
    ...
    <div id="corpo">
        <div id="tabs">
            <ul>
                <li><a href="#tabs-1">Emitir Guia de Férias</a></li>
            ...
            <div id="tabs-1">
                ...
                <div id="formulario">
                    <form name="form" id="form_user" action="pdf_guia_ferias.php?id_funcionario=<?php echo $_GET['id_funcionario']; ?>" method="post" enctype="multipart/form-data" target="new">
                        <fieldset>
                            <label>
                                <span>ID</span>
                            ...
                            <label>
                                ...
                                <input type="text" name="inicio" id="inicio" value="12 de Dezembro de 2013"/>
                            </label>

                            <label>
                                <span># de Dias úteis</span>
                                <input type="text" name="dias" id="dias" value="22"/>
                            </label>
                            
                            <input type="submit" id="button" class="send" value="Emitir" name="emitir"/>
                            <a href="index.php?<?php echo md5('pagina feria'); ?>">cancelar</a>
